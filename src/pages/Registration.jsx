         ...
         <div className=" lg:w-[55%] pl-[190px] pt-[50px]">
           ...
           <div className="mt-[60px]">
             ...
             <div className="w-[368px] text-center ">
               <button onClick={handleRegistration} className=' w-full font-semibold font-nunito text-[20px] text-white py-[20px] px-[130px] bg-black rounded-[86px] mt-[20px]'>Sign up</button>
